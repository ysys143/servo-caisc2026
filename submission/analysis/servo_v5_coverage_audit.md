...
| C05 | Adam (sparkes2010robot) | 11 | 1,3-6,8,9 | 2,7,10,11 | Adam material 집중; Eve(6-8 일부)·references(9-11)는 out of scope | **page 2,7,10 미확인** — Adam 관련 문장 잔존 여부 스팟체크 권장 |
...
- **C05:** page 2,7,10 Adam-관련 문장 스팟체크 권장(freeze 전 또는 T13 제2검토자).

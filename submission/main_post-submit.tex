...
\begin{description}
  ...
  The public package now includes the package-applicable mutation and conformance tests cited as regression evidence. Repository-only manuscript, external-publication, source-vault, and finalization tests remain repository gates rather than being represented as executable public-package tests.
\end{description}

\noindent\textbf{Scope of revision.} The entries above are the complete set of changes
made since the archival deposit, R1--R50. Entries R3--R12 narrow or correct statements
...
contracts finalized through R33--R50. References in earlier entries to ``final'' Schema~1 tables or current

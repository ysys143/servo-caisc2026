...
\midrule
Math (formal) & $V_\text{formal}$ & Exact for formal validity & Mechanical formal eval. & RL/MCTS  & Pretraining contamination \\
...
made since the archival deposit, R1--R19. Entries R3--R12 narrow or correct statements
...
the untestable direction-consistency statement. These changes do not alter the six-component framework, the three open

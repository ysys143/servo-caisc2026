...
\begin{description}
  ...
  \item[R19. Correction status, novelty assessment, and untested association (Abstract; Table~\ref{tab:core-comparison}; Appendix~\ref{app:coding}).]

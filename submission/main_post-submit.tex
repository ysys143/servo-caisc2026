...
\item {\bf Experimental result reproducibility}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: This paper contains no computational experiment, but its main case annotations and closure predicates depend on the Servo event--artifact package. The synchronized package, validator, canonical records, generated tables, evidence ledger, audit record, and corrected manuscript are bound in the versioned, checksum-bound release at \url{https://github.com/ysys143/servo-caisc2026/releases/tag/servo-corrected-v3.0.16}. Its manifest and attestation provide file-level checksums for the revised status matrix and make later asset replacement detectable; the hosting platform does not make the release immutable.
...
made since the archival deposit, R1--R49. Entries R3--R12 narrow or correct statements
...
contracts finalized through R33--R49. References in earlier entries to ``final'' Schema~1 tables or current
